...
class Netbrain():
    ...
    def CreateSite(self):
        ...
        #sitePath = "My Network/Test_Container1/MuraliKrishna"
        #sitePath = input("Enter SitePath: (Format:My Network/Test_Container1/KMKrishna):\n")
        Container = input("Enter name of the container:")
        Leaf = input("Provide Leaf Name to Create:")
        sitePath = str("My Network/"+Container+"/"+Leaf)
        print("Creating Site Path:", sitePath)
